/**
 * GET /api/contratos/[id]/assinatura/evidencias
 *
 * Retorna o PDF de evidências da assinatura nativa.
 * Acesso restrito a usuários do workspace dono do contrato.
 *
...
export async function GET(
  ...
  const pdfBuffer = await renderEvidenciaPdf({
