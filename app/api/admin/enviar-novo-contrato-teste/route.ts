 ...
 * Usa o template e o staff "Admin Mercograin" como assinatura prévia da corretora.
 */
...
export async function POST(req: NextRequest) {
  ...
  const proposta = await db.proposta.create({
    data: {
      ...
      status: 'aceita',
      descricao: 'Contrato de teste com logo e assinatura prévia da corretora',
  ...
  // Pega o owner como "signatário staff"
