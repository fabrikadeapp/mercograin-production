...
export const AREA_SUBMENU: Record<Area, AreaSubItem[]> = {
  ...
  gestao: [
    { href: '/admin-empresa', label: 'Painel administrativo' },
    { href: '/gestao/equipe', label: 'Equipe' },
    { href: '/configuracoes', label: 'Configurações' },
    { href: '/configuracoes/empresa', label: 'Dados da empresa' },
    { href: '/configuracoes/marca', label: 'Marca & Logo' },
    { href: '/configuracoes/integracoes', label: 'Integrações' },
    { href: '/configuracoes/fluxo-trabalho', label: 'Fluxo de trabalho' },
    { href: '/configuracoes/ai', label: 'Agente IA' },
    { href: '/configuracoes/cotacoes', label: 'Commodities exibidas' },
